...
void Renderer::clearEntryWords(byte language, word matrix[16]) {
  switch (language) {
#ifdef ENABLE_LANGUAGE_DE
    case LANGUAGE_DE_DE:
    case LANGUAGE_DE_SW:
...
void Renderer::activateAMPM(byte hours, byte language, word matrix[16]) {
  switch (language) {
#ifdef ENABLE_LANGUAGE_DE
    case LANGUAGE_DE_DE:
    case LANGUAGE_DE_SW:
